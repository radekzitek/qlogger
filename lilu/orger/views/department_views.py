...
class DepartmentListView(ListView):
    model = Department
    template_name = 'orger/department_list.html'
    context_object_name = 'departments'


class DepartmentDetailView(DetailView):
    model = Department
    template_name = 'orger/department_detail.html'
...
class DepartmentCreateView(CreateView):
    ...
    template_name = 'orger/department_form.html'
...
class DepartmentDeleteView(DeleteView):
    model = Department
    template_name = 'orger/department_confirm_delete.html'
    success_url = reverse_lazy('department_list')
