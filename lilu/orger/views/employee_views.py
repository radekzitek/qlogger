...
class EmployeeListView(ListView):
    model = Employee
    template_name = 'orger/employee_list.html'
    context_object_name = 'employees'


class EmployeeDetailView(DetailView):
    model = Employee
    template_name = 'orger/employee_detail.html'
...
class EmployeeCreateView(CreateView):
    ...
    template_name = 'orger/employee_form.html'
    success_url = reverse_lazy('employee_list')

class EmployeeCreateAndAssignView(View):
    template_name = 'orger/employee_create_and_assign.html'
...
class EmployeeDeleteView(DeleteView):
    model = Employee
    template_name = 'orger/employee_confirm_delete.html'
    success_url = reverse_lazy('employee_list')
